...
export const homeSlides: HomeSlide[] = [
  {
    ...
    secondaryCta: { label: 'Voir le produit', href: '/keymod/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Voir le produit', href: '/kvmgo/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Voir le produit', href: '/minikvm/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Voir les accessoires', href: '/accessories/' },
