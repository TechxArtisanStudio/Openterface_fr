...
export const homeSlides: HomeSlide[] = [
  {
    ...
    primaryCta: { label: 'Soutenir MAINTENANT', href: siteConfig.links.keymodCrowdsupply, external: true },
  ...
  },
  {
    ...
    primaryCta: { label: 'Précommander MAINTENANT', href: siteConfig.links.kvmgoPurchase, external: true },
  ...
  },
  {
    ...
    primaryCta: { label: 'Commander MAINTENANT', href: siteConfig.links.minikvmPurchase, external: true },
  ...
  },
  {
    ...
    primaryCta: { label: 'Acheter MAINTENANT', href: siteConfig.links.shop, external: true },
